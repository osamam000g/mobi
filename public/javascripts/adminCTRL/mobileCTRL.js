//mobile CTRL
//=====================================================================
app.controller('mobileCTRL' , function($scope , $http , $timeout , $window , $location){
...
//             console.log("error");
             ...
             $scope.show.loading = true ; 
              $http.post('/view/addmobile' , data ).then(function(response){
    ...
    $scope.getAllMobile = function(){
         $http.post('/view/getmobiles').then(function(response){
             ...
             if(!response){ 
                    ...
                    $scope.mobiles = response.data.reverse() ; 
...
//pagination
//----------------------
 app.filter('mobilePagination', function(){
